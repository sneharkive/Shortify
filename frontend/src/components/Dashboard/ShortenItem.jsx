...
// import { Hourglass } from 'react-loader-spinner';   // need to us 'react-spinners'
...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate, refetch }) => {
  ...
  const deleteHandler = async (shortUrl) => {
    try {
      const { data } = await api.delete(`/api/urls/delete/${shortUrl}`, {
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
          Authorization: "Bearer " + token,
    ...
    >
      ...
      >
        ...
        <div className="flex  flex-1  sm:justify-end items-center gap-4">
          ...
          >
            <div className="flex cursor-pointer gap-1 items-center bg-btnColor py-1  font-semibold shadow-md shadow-slate-500 px-2 rounded-md text-white ">
          ...
          <div
            ...
            className="flex cursor-pointer gap-1 items-center bg-green-600 py-1 font-semibold shadow-md shadow-slate-500 px-2 rounded-md text-white "
          >
          ...
          <div
            ...
            className="flex cursor-pointer gap-1 items-center bg-rose-700 py-1 font-semibold shadow-md shadow-slate-500 px-2 rounded-md text-white "
          >
